#include "snd/BiquadFilterPresets.h"
...
const BiquadFilterCallback::Coefficients BiquadFilterLpf::cCoefficientsTable[BiquadFilterLpf::cCoefficientsTableSize] = {
    //    n0      n1      n2      d1      d2
    ...
    { 0x1801, 0x3002, 0x1801, 0xec40, 0xee0b },     // 8192 Hz
    ...
    { 0x08d0, 0x119f, 0x08d0, 0x3166, 0xe945 },     // 4096 Hz
    ...
    { 0x02d0, 0x059f, 0x02d0, 0x589c, 0xdb7a },     // 2048 Hz
    ...
    { 0x00ce, 0x019c, 0x00ce, 0x6cb7, 0xcfe1 },     // 1024 Hz
    ...
    { 0x0037, 0x006e, 0x0037, 0x768d, 0xc889 },     // 512 Hz
...
// HPF coefficients
// (1/16 octave interval, Chebyshev approximation)
const BiquadFilterCallback::Coefficients BiquadFilterHpf::cCoefficientsTable[BiquadFilterHpf::cCoefficientsTableSize] = {
    //    n0      n1      n2      d1      d2
    { 0x3bb5, 0x8895, 0x3bb5, 0x7e7b, 0xc17f },     // 128 Hz
    ...
    { 0x3b00, 0x8a00, 0x3b00, 0x7cf1, 0xc2f4 },     // 256 Hz
    ...
    { 0x3999, 0x8ccd, 0x3999, 0x79d2, 0xc5c6 },     // 512 Hz
    ...
    { 0x36d9, 0x924d, 0x36d9, 0x736b, 0xcb05 },     // 1024 Hz
    ...
    { 0x3190, 0x9cdf, 0x3190, 0x6620, 0xd41f },     // 2048 Hz
    ...
    { 0x27c5, 0xb075, 0x27c5, 0x4a34, 0xe1b1 },     // 4096 Hz
    ...
    { 0x167b, 0xd30a, 0x167b, 0x0dc1, 0xee80 }      // 8192 Hz
};

// BPF coefficients 1
// (center frequency of 512 Hz, Chebyshev approximation)
const BiquadFilterCallback::Coefficients BiquadFilterBpf512::cCoefficientsTable[BiquadFilterBpf512::cCoefficientsTableSize] = {
    //    n0      n1      n2      d1      d2
...
const BiquadFilterCallback::Coefficients BiquadFilterBpf1024::cCoefficientsTable[BiquadFilterBpf1024::cCoefficientsTableSize] = {
    //    n0      n1      n2      d1      d2
...
const BiquadFilterCallback::Coefficients BiquadFilterBpf2048::cCoefficientsTable[BiquadFilterBpf2048::cCoefficientsTableSize] = {
    //    n0      n1      n2      d1      d2
...
{
    s32 coefSize = cCoefficientsTableSize;
    s32 coefIndex = static_cast<s32>(static_cast<f32>(coefSize - 1) * value);

    coefIndex = sead::Mathi::clamp2(0, coefIndex, cCoefficientsTableSize - 1);
    *coef = cCoefficientsTable[coefIndex];
}

void BiquadFilterHpf::getCoefficients(s32 type, f32 value, BiquadFilterCallback::Coefficients* coef) const
{
    s32 coefSize = cCoefficientsTableSize;
    s32 coefIndex = static_cast<s32>(static_cast<f32>(coefSize - 1) * value);
...
void BiquadFilterBpf512::getCoefficients(s32 type, f32 value, BiquadFilterCallback::Coefficients* coef) const
{
    value *= (2.0f - value); // weighting for taking the coefficients
...
void BiquadFilterBpf1024::getCoefficients(s32 type, f32 value, BiquadFilterCallback::Coefficients* coef) const
{
    value *= (2.0f - value); // weighting for taking the coefficients
...
void BiquadFilterBpf2048::getCoefficients(s32 type, f32 value, BiquadFilterCallback::Coefficients* coef) const
{
    value *= (2.0f - value); // weighting for taking the coefficients
